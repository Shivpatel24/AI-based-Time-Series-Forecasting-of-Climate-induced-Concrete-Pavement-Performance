...
output_csv = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/SARIMA/output_sarimax.csv'

# Initialize output file
output_df = pd.DataFrame(columns=['Actual_TL', 'Predicted_TL'])
...
for file_path in tqdm(all_csv_files, desc="Processing SARIMAX files"):
    try:
        ...
        df = df.asfreq('H')  # FIXED: Set frequency to hourly correctly
