...
model_save_path = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/LSTM/Model/lstm_cesr_seq3_albx.pth'
scaler_folder = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/LSTM/Scalers'
scaler_save_path = os.path.join(scaler_folder, 'lstm_cesr_seq3_albx.save')
...
model = LSTMModel(input_size=n_features, hidden_size=12).to(device)
