...
model_save_path = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/RNN/Model/rnn_tl_seq3_albx_2layer.pth'
scaler_folder = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/RNN/scalers'
scaler_save_path = os.path.join(scaler_folder, 'rnn_tl_seq3_albx_2layers.save')
...
def process_file(fp, depth, alb, seq_len=3):
    try:
        df = pd.read_csv(fp)
