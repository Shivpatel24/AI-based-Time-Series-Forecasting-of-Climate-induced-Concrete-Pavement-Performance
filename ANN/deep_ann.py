...
model_save_path = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/ANN/Model/ann_tl_deep.pth'  # changed file name
scaler_folder = '/home/bel/Desktop/Shiv_SRIP/ATenLoc/ANN/scalersann'
scaler_save_path = os.path.join(scaler_folder, 'ann_tl_deep.save')
...
for folder in all_folders:
    ...
    for fp in all_files:
        ...
        train_part = train_part.sample(frac=1, random_state=seed).reset_index(drop=True)
...
X_train = final_train_df.drop(columns='TL').values
y_train = final_train_df['TL'].values
X_test = final_test_df.drop(columns='TL').values
y_test = final_test_df['TL'].values
